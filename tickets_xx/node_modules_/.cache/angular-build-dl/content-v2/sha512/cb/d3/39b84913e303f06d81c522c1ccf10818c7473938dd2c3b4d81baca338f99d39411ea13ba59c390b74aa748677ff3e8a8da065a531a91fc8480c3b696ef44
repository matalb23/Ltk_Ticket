...
const routes = [
    ...
    {
        path: 'login',
        loadChildren: () => __webpack_require__.e(/*! import() | auth-login-login-module */ "auth-login-login-module").then(__webpack_require__.bind(null, /*! ./auth/login/login.module */ "./src/app/auth/login/login.module.ts")).then(m => m.LoginPageModule)
    },
    {
        path: 'template-create/:username',
        loadChildren: () => __webpack_require__.e(/*! import() | template-create-template-create-module */ "template-create-template-create-module").then(__webpack_require__.bind(null, /*! ./template-create/template-create.module */ "./src/app/template-create/template-create.module.ts")).then(m => m.TemplateCreatePageModule)
    },
    {
        path: 'inicio',
        loadChildren: () => __webpack_require__.e(/*! import() | auth-inicio-inicio-module */ "auth-inicio-inicio-module").then(__webpack_require__.bind(null, /*! ./auth/inicio/inicio.module */ "./src/app/auth/inicio/inicio.module.ts")).then(m => m.InicioPageModule)
    },
    {
        path: 'help',
    ...
    {
        path: 'help2',
        loadChildren: () => __webpack_require__.e(/*! import() | help2-help2-module */ "help2-help2-module").then(__webpack_require__.bind(null, /*! ./help2/help2.module */ "./src/app/help2/help2.module.ts")).then(m => m.Help2PageModule)
    },
    {
        path: 'help3',
        loadChildren: () => __webpack_require__.e(/*! import() | help3-help3-module */ "help3-help3-module").then(__webpack_require__.bind(null, /*! ./help3/help3.module */ "./src/app/help3/help3.module.ts")).then(m => m.Help3PageModule)
    },
    {
        path: 'help4',
        loadChildren: () => __webpack_require__.e(/*! import() | help4-help4-module */ "help4-help4-module").then(__webpack_require__.bind(null, /*! ./help4/help4.module */ "./src/app/help4/help4.module.ts")).then(m => m.Help4PageModule)
    },
    {
        path: 'ver-tks/:tipo',
...
/* harmony import */ var _service_settings_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./service/settings.service */ "./src/app/service/settings.service.ts");
/* harmony import */ var _service_fcm_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./service/fcm.service */ "./src/app/service/fcm.service.ts");
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, auth, router, settings, fcmService) {
        ...
        this.platform.ready().then(() => {
            ...
            this.auth.authSubject.subscribe(state => {
                if (state) {
                    ...
                    var user = {};
                    user.login = this.settings.getValue(_service_settings_service__WEBPACK_IMPORTED_MODULE_7__["SettingsService"].setting_User);
                    user.password = this.settings.getValue(_service_settings_service__WEBPACK_IMPORTED_MODULE_7__["SettingsService"].setting_UserPass);
...
/* harmony import */ var _service_settings_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./service/settings.service */ "./src/app/service/settings.service.ts");
...
/* harmony import */ var _service_http_config_interceptor__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./service/http-config.interceptor */ "./src/app/service/http-config.interceptor.ts");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            ...
            { provide: _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouteReuseStrategy"], useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicRouteStrategy"] }, _service_settings_service__WEBPACK_IMPORTED_MODULE_10__["SettingsService"]
        ],
...
let AuthService = class AuthService {
    constructor(api, settings, httpClient) {
        this.api = api;
        this.settings = settings;
    ...
    login(user) {
        ...
        return this.api.post('token', data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((res) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (res.access_token) {
...
let FcmService = class FcmService {
    ...
    initPush() {
        ...
        if (_capacitor_core__WEBPACK_IMPORTED_MODULE_4__["Capacitor"].platform !== 'web') {
            ...
            const isPushNotificationsAvailable = _capacitor_core__WEBPACK_IMPORTED_MODULE_4__["Capacitor"].isPluginAvailable('PushNotifications');
    ...
    registerPush() {
        ...
        PushNotifications.addListener('registration', (token) => {
            this.settings.setValue(_service_settings_service__WEBPACK_IMPORTED_MODULE_3__["SettingsService"].setting_TokenFCM, token);
            var data = '{ "login": "' + this.settings.getValue(_service_settings_service__WEBPACK_IMPORTED_MODULE_3__["SettingsService"].setting_User) + '", "mobile_so": "' + _capacitor_core__WEBPACK_IMPORTED_MODULE_4__["Capacitor"].platform.substr(0) + '", "mobile_token": "' + token.value + '" }';
...
/* harmony import */ var _settings_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./settings.service */ "./src/app/service/settings.service.ts");
...
let HttpConfigInterceptor = class HttpConfigInterceptor {
    constructor(settings, loadingCtrl, toastCtrl) {
        this.settings = settings;
    ...
    intercept(req, next) {
        let authReq = req;
        const token = this.settings.getValue(_settings_service__WEBPACK_IMPORTED_MODULE_5__["SettingsService"].setting_Token);
        ...
        this.presentLoading();
        return next.handle(authReq).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((event) => {
    ...
    dismissLoading() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.isLoading = false;
            return yield this.loadingCtrl.dismiss().then(() => null); //console.log('dismissLoading')
        });
    }
...
SettingsService = SettingsService_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], SettingsService);
...
module.exports = __webpack_require__(/*! C:\Projects\Ltk_Ticket\tickets\src\main.ts */"./src/main.ts");
