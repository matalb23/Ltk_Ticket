...
/* harmony import */ var _service_fcm_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../service/fcm.service */ "./src/app/service/fcm.service.ts");
...
let HomePage = class HomePage {
    constructor(api, settings, router, fcmService, platform) {
        //+ this.ngOnInit();
        this.api = api;
    ...
    getMisTemplates() {
        ...
        this.api.get("api/template?login=" + this.settings.getValue(_service_settings_service__WEBPACK_IMPORTED_MODULE_2__["SettingsService"].setting_User)).subscribe((data) => {
